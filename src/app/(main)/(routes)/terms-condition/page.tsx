...
const TermsCondition = () => {
  return (
    <div className="container mx-auto p-4">
      ...
      <Separator
        className="h-px w-28 mx-auto mb-10 bg-[#8a8282]"
        orientation="horizontal"
      />
      <p className="text-gray-600 mt-14 text-[#525252] text-sm">
        Last Update: 10/04/2024 10:26 AM
      </p>
      <p className="text-gray-600 text-[#525252] mb-10 text-sm">
      ...
      <p className="text-gray-600 text-sm text-[#525252] mt-4">
      ...
      <h3 className="text-lg mt-3">Definitions</h3>
      <p className="text-gray-600 mt-4 text-[#525252] text-sm">
        For the purposes of these Terms and Conditions:
      </p>
      <ul className="list-disc text-[#525252] text-sm mt-4 mb-4">
        <li className="mt-3 ">
        ...
        <li className="mt-3">
          ...
          "Us" or "Our" in this Agreement) refers to CodexBlock Private Limited,
          37/4, 3RD FLOOR, 5TH CROSS ROAD 15TH MAIN ROAD, KAMARAJAPALLI
          BANGALORE.
        </li>
        <li className="mt-3">
        ...
        <li className="mt-3">
          ...
          and the Company regarding the use of the Service.This Terms and condition agreeemnt has been created with the help of the{" "} 
          <a href="Terms and Condition Generator" className="text-blue-500 underline">
        ...
        <li className="mt-3">
          <strong>Website</strong> refers to CodexBlocks, accessible from{" "}
          <a href="https://www.codexblocks.com" className="text-blue-500 underline">
            www.codexblocks.com
          </a>
        </li>
        <li className="mt-3">
      ...
      <h2 className="text-xl font-bold mt-10">Acknowledgment</h2>
      <p className="text-gray-600 text-[#525252] text-sm mt-4">
      ...
      <h2 className="text-xl font-bold mt-10">Links to Other Websites</h2>
      <p className="text-gray-600 text-[#525252] text-sm mt-4">
      ...
      <p className="text-gray-600 text-[#525252] text-sm mt-4">
        ...
        apply to You. But in such a case the exclusions and limitations set
      ...
      <h2 className="text-xl font-bold mt-10">Disputes Resolution</h2>
      <p className="text-gray-600 text-[#525252] text-sm mt-4">
      ...
      <h2 className="text-xl font-bold mt-10">For European Union (EU) Users</h2>
      <p className="text-gray-600 text-[#525252] text-sm mt-4">
      ...
      <h2 className="text-xl mt-10">Severability and Waiver</h2>
      <h3 className="text-lg mt-3 text-[#525252]">Severability</h3>
      <p className="text-gray-600 text-sm text-[#525252] mt-4">
      ...
      <h3 className="text-lg text-[#525252] mt-3">Waiver</h3>
      <p className="text-gray-600 text-[#525252] mt-4 text-sm">
      ...
      <h2 className="text-xl font-bold mt-10">Translation Interpretation</h2>
      <p className="text-gray-600 text-[#525252] text-sm mt-4">
      ...
      <p className="text-gray-600 text-[#525252] text-sm mt-4">
        ...
        contact us : contact@codebiosis.com
      </p>
    </div>
  );
};
